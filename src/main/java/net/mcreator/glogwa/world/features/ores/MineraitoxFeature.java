...
public class MineraitoxFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		PLACED_FEATURE = PlacementUtils.register("glogwa68:mineraitox", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(5), HeightRangePlacement.uniform(VerticalAnchor.absolute(7), VerticalAnchor.absolute(15))));
		return FEATURE;
	}
