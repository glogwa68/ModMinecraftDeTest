...
import net.mcreator.glogwa.client.renderer.EnderChickenRenderer;
...
public class Glogwa68ModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(Glogwa68ModEntities.ENDER_CHICKEN.get(), EnderChickenRenderer::new);
	}
}
